...
public class MigrationClientTest {
	...
	private MigrationClientImpl migrationClient;
	...
	public void before() throws Exception {
		...
		migrationClient = new MigrationClientImpl(mockClientFactory, mockConfiguration);
	}
	...
	public void testGetCommonMigrationTypes() throws Exception {
		...
		MigrationClientImpl migClient = new MigrationClientImpl(mf, mockConfiguration);
