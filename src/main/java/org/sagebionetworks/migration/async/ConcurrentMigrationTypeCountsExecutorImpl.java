...
public class ConcurrentMigrationTypeCountsExecutorImpl implements TypeCountsExecutor {
    static private Logger logger = LogManager.getLogger(ConcurrentMigrationTypeCountsExecutorImpl.class);

    private ExecutorService threadPool;
    private AsyncMigrationTypeCountsWorkerFactory workerFactory;

    @Inject
    public ConcurrentMigrationTypeCountsExecutorImpl(ExecutorService threadPool,
